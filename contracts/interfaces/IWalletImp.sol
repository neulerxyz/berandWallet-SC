...
interface IWalletImp {
    ...
    function mintFromNFTViaRelayer(address nftContract, uint256 _nonce, uint256 salt, bytes memory _proxySignature) external;
    function mintFromNFT(address nftContract) external;
